class ContactMailer < ApplicationMailer
  ...
  def staff_email
    ...
    mail(to: target, subject: "Booking #{@booking.number_of_beds} beds from #{@booking.start_date.strftime("%d/%m/%Y")} to #{@booking.start_date.strftime("%d/%m/%Y")} at #{@booking.hostel.name}")
  end
end
